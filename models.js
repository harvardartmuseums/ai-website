module.exports = {
  ...
  // OpenAI
  'gpt-4':                                            { name: 'GPT-4',                released: null,         openWeight: false },
  ...
  // Google
  'gemini-2.0-flash':                                { name: 'Gemini 2.0 Flash',      released: null,         openWeight: false },
  'gemini-2.0-flash-lite':                           { name: 'Gemini 2.0 Flash Lite', released: null,         openWeight: false },
  'gemini-2.5-flash':                                { name: 'Gemini 2.5 Flash',      released: null,         openWeight: false },
  'gemini-2.5-flash-lite':                           { name: 'Gemini 2.5 Flash Lite', released: null,         openWeight: false },
  // Meta
  ...
  // Amazon
  'amazon.nova-lite-v1:0':                           { name: 'Nova Lite',             released: null,         openWeight: false },
  'amazon.nova-pro-v1:0':                            { name: 'Nova Pro',              released: null,         openWeight: false },
  'us.amazon.nova-2-lite-v1:0':                      { name: 'Nova 2 Lite',           released: null,         openWeight: false },
  // Mistral
  'us.mistral.pixtral-large-2502-v1:0':              { name: 'Pixtral Large',         released: '2025-02-01', openWeight: true  },
  'mistral.magistral-small-2509':                    { name: 'Magistral Small',       released: '2025-09-01', openWeight: true  },
  'mistral.ministral-3-14b-instruct':                { name: 'Ministral 14B',         released: null,         openWeight: true  },
  'mistral.ministral-3-3b-instruct':                 { name: 'Ministral 3B',          released: null,         openWeight: true  },
  'mistral.ministral-3-8b-instruct':                 { name: 'Ministral 8B',          released: null,         openWeight: true  },
  'mistral.mistral-large-3-675b-instruct':           { name: 'Mistral Large 3 675B',  released: null,         openWeight: true  },
  // Qwen
  ...
  'qwen.qwen3-vl-235b-a22b':                         { name: 'Qwen3 VL 235B',         released: null,         openWeight: true  },
  // Moonshot
  'moonshotai.kimi-k2.5':                            { name: 'Kimi K2.5',             released: null,         openWeight: true  },
  // Writer
  'writer.palmyra-vision-7b':                        { name: 'Palmyra Vision 7B',     released: null,         openWeight: false },
  // Clarifai / legacy
